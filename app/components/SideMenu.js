...
// import {isLocale, setLocale} from "../redux/actions/languageAction";
...
export class SideMenu extends Component {
    constructor(props) {
        super(props);
        // console.log(this.props.appLocale());

        // this.props.setLocale("Asdf");
        this.state = {
            token: '',
            user: {}
        }
    ...
    render() {
        ...
        // setLocale("Asdf");
        // console.log(strings.save);
        // console.log(strings);
        // isLocale('en') && setAppLocale("ar");
        this.lang = lang;
            ...
            <View style={styles.container}>
                <View style={this.isLoggedIn ? styles.menuHeader : styles.menuLoggedOut}>
                    ...
                    <TouchableOpacity activeOpacity={.7}
                                      style={{alignSelf: this.lang == 'en' ? 'flex-end' : 'flex-start', margin: 5}}
                                      onPress={() => {
                                          this.props.navigation.closeDrawer()
                                      }}>
                ...
                <ScrollView style={styles.itemsList}>
                    <TouchableOpacity activeOpacity={.7} onPress={() => {
                        ...
                        height: 50,
                        marginVertical: 1,
                        backgroundColor: routeName === 'Home' ? '#000' : '#eee',
                        flexDirection: 'row',
                        alignItems: 'center',
                    ...
                    {this.lang !== 'ar' &&  (<TouchableOpacity activeOpacity={.7} onPress={() => {
                        ...
                        <View style={{
                            ...
                            <Text style={{color: '#eee', fontSize: 15}}>العربية</Text>
                        </View>
                    </TouchableOpacity>) }
...

                    {
                        this.props.auth.isLoggedIn == true ? (
                            <TouchableOpacity activeOpacity={.7} onPress={() => {
                                ...
                                height: 50,
                                marginVertical: 1,
                                backgroundColor: routeName == 'MyOrders' ? '#000' : '#eee',
                                flexDirection: 'row',
                                alignItems: 'center',
                                justifyContent: 'space-around'
                            }}>
                                    ...
                                    this.lang == 'en' ? (
                                        <View>
                                            <Icon name="md-cart" size={28}
                                                  color={routeName == 'MyOrders' ? '#eee' : '#000'}/>
                                        </View>
                                    ) : null
                                }
                                <View style={{
                                    justifyContent: 'center',
                                    alignItems: this.lang == 'ar' ? 'flex-end' : 'flex-start',
                                    width: '55%',
                                }}>
                                    <Text style={{color: routeName == 'MyOrders' ? '#eee' : '#000', fontSize: 15}}>My
                                        Orders</Text>
                                </View>
                                {
                                    this.lang == 'ar' ? (
...

                    {
                        this.props.auth.isLoggedIn == true ? (
                            <TouchableOpacity activeOpacity={.7} onPress={() => {
                                ...
                                height: 50,
                                marginVertical: 1,
                                backgroundColor: routeName == 'Followers' ? '#000' : '#eee',
                                flexDirection: 'row',
                                alignItems: 'center',
                                justifyContent: 'space-around'
                            }}>
                                {
                                    this.lang == 'en' ? (
                                        <View>
                                            <Icon name="md-contact" size={28}
                                                  color={routeName == 'Followers' ? '#eee' : '#000'}/>
                                        </View>
                                    ) : null
                                }
                                <View style={{
...

                    {
                        this.props.auth.isLoggedIn == true ? (
                            <TouchableOpacity activeOpacity={.7} onPress={() => {
                                this.props.navigation.navigate('PaymentsRecords')
                            }} style={{
                                width: '100%',
                                height: 50,
                                marginVertical: 1,
                                backgroundColor: routeName == 'PaymentsRecords' ? '#000' : '#eee',
                                flexDirection: 'row',
                                alignItems: 'center',
                                justifyContent: 'space-around'
                            }}>
                                {
                                    this.lang == 'en' ? (
                                        <View>
                                            <Icon name="md-cash" size={28}
                                                  color={routeName == 'PaymentsRecords' ? '#eee' : '#000'}/>
                                        </View>
                                    ) : null
                                }
                                <View style={{
...

                    {
                        this.props.auth.isLoggedIn == true ? (
                            <TouchableOpacity activeOpacity={.7} onPress={() => {
                                ...
                                height: 50,
                                marginVertical: 1,
                                backgroundColor: routeName == 'Notifications' ? '#000' : '#eee',
                                flexDirection: 'row',
                                alignItems: 'center',
                                justifyContent: 'space-around'
                            }}>
                                {
                                    this.lang == 'en' ? (
                                        <View>
                                            <Icon name="md-notifications-outline" size={28}
                                                  color={routeName == 'Notifications' ? '#eee' : '#000'}/>
                                        </View>
                                    ) : null
                                }
                                <View style={{
                    ...
                    <TouchableOpacity activeOpacity={.7} onPress={() => {
                        ...
                        height: 50,
                        marginVertical: 1,
                        backgroundColor: routeName == 'ContactUs' ? '#000' : '#eee',
                        flexDirection: 'row',
                        alignItems: 'center',
                        justifyContent: 'space-around'
                    }}>
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                color: routeName == 'ContactUs' ? '#eee' : '#000',
                                fontSize: 15,
                                textAlign: 'center'
                            }}>Contact Us</Text>
                        </View>
...

                    {
                        this.props.auth.isLoggedIn == true ? (
                            <View style={{margin: 5}}>
                                <TouchableOpacity activeOpacity={.7} onPress={this._handleLogout}
                                                  style={{padding: 8, height: 40, backgroundColor: '#000'}}>
                                    <Text style={{color: 'white', fontSize: 15, textAlign: 'center', marginTop: 5}}>Log
                                        Out</Text>
                                </TouchableOpacity>
                            </View>
                        ) : null
...
const styles = StyleSheet.create({
    ...
    viewStyle: {
        // alignItems: isLocale('ar') ? 'flex-end' : "flex-start",
        alignItems: 'flex-end',
    }
});