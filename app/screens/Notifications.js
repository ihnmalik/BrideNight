    ...
    if(this.state.lang == 'ar') {
      return (
        <View key={item.id} style={{ padding: 3, width: '100%', borderBottomWidth: 1, borderBottomColor: '#eee'}}>
          <TouchableOpacity activeOpacity={.8} style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-end'}} onPress={() => this.props.navigation.navigate('NotificationDetail')}>  
            <View style={{flex: 1, alignItems: 'flex-end', padding: 8}}>
              <Text style={{fontSize: 17}}>رقم الاشعار #123</Text>
              <Text style={{fontSize: 13, marginTop:5, fontWeight: '200'}}>12/10/2019</Text>
              {/* <Text style={{fontSize: 13, marginTop:5, fontWeight: '200'}}>رقم العملية #12100</Text> */}
              {/* <Text style={{fontSize: 16, color: 'red'}}>100 SAR الإجمالي</Text> */}
              {/* <Text style={{fontSize: 12, marginTop:5, textAlign: 'left', color: 'green'}}>Successful حالة العملية</Text> */}
            </View>
          </TouchableOpacity>
        </View>
      )
      ...
      return (
        <View key={item.id} style={{ padding: 3, width: '100%', borderBottomWidth: 1, borderBottomColor: '#eee'}}>
          <TouchableOpacity activeOpacity={.8} style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-start'}} onPress={() => this.props.navigation.navigate('NotificationDetail')}>  
