            ...
            <View style={styles.container}>
                    ...
                    <KeyboardAvoidingView style={{flex: 1, backgroundColor: '#eee'}}>
                        <ScrollView style={{paddingTop: 30}}>
                            <Text style={{textAlign: 'center', fontSize: 19, color: 'gray', padding: 15}}>We welcome your suggestions, comments and complaints</Text>
                            <View style={{padding: 18,}}>
                                <TextInput placeholder="Type in your e-mail..." style={{padding: 14, backgroundColor: '#fff', borderRadius: 18, marginTop: 15, fontSize: 14 }} />
                                <View style={{flexDirection: 'row', justifyContent: 'space-between', padding: 14, backgroundColor: '#fff', borderRadius: 18, marginTop: 15, fontSize: 14 }}>
                                    <TextInput placeholder="Select Communication Type"  />
                                    <Icon name="ios-arrow-down" size={23} /> 
                                </View>

                                <View style={{padding: 14, backgroundColor: '#fff', borderRadius: 18, marginTop: 8, height: 200 }}>
                                  <TextInput placeholder="Type In your message..." multiline style={{ fontSize: 14, }} />
                                </View>
