    ...
    return (
      <ScrollView style={{flex: 1, backgroundColor: '#eee'}}>
         <View style={{marginHorizontal: 9, marginVertical: 4, backgroundColor: 'white'}}>
            <Text style={{textAlign: 'center', padding: 10, fontSize: 18, fontWeight: '200'}}>Notification</Text>
            <Text style={{textAlign: 'center', padding: 10, fontSize: 15, fontWeight: '600', color: 'orange'}}>رقم الاشعار #123</Text>
            <Text style={{textAlign: 'center', padding: 10, fontSize: 15, fontWeight: '500', color: 'gray'}}>It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</Text>
