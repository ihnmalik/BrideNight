...
const users = [{
  ...
  "image_url": "https://www.firstchoicemobility.com/images/source/Karma_Mobility_Wheelchair_Images/karma_advantage_self_propel_wheelchair.jpg"
}, {
  "id": 2,
  "first_name": "المؤسسة العامة للتعاقد",
  "last_name": "Fernely",
  "email": "sfernely1@lulu.com",
  "image_url": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAJ08q5h_4kANe8Bxomctcl_d8vTYStMRnoVhEM_iD5DEnQnkA1g"
}, {
  "id": 3,
  "first_name": "منصة معروف",
  "last_name": "McCudden",
  "email": "bmccudden2@google.ca",
  "image_url": "https://www.scooterlink.com/images/products/Project%20614HD_large.jpg"
}, {
  "id": 4,
...
export class MyDonations extends Component {
      ...
      return (
        <View key={item.id} style={{ padding: 3, width: '100%', borderBottomWidth: 1, borderBottomColor: '#eee'}}>
          <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-end'}}>  
            ...
            <View style={{borderBottomLeftRadius: 15, borderTopLeftRadius: 15, borderWidth: 1, borderColor: '#eee'}}>
              <Image
                source={{uri: item.image_url}} 
                style={{height: 120, width: 120, borderBottomLeftRadius: 15, borderTopLeftRadius: 15,}}
              />
            </View>
          </View>
        </View>
        ...
        <View key={item.id} style={{ padding: 3, width: '100%', borderBottomWidth: 1, borderBottomColor: '#eee'}}>
          <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-start'}}>  
            <View>
              <Image
                source={{uri: item.image_url}} 
                style={{height: 120, width: 120, borderBottomRightRadius: 15, borderTopRightRadius: 15}}
              />
            </View>
